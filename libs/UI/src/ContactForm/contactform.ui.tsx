    ...
    <div className="mb-10">
      <div className="flex flex-col md:flex-row items-center justify-between gap-9 p-4 mb-10">
        <h2 className="text-3xl md:text-4xl font-bold ">
          {contact?.contactus?.contactusTitle}
        </h2>

        <p className="max-w-md text-gray-400 md:text-end">
          {contact?.contactus?.contactusDescription}
        </p>
      </div>
      <section className="grid grid-cols-1 md:grid-cols-2 justify-between items-center gap-4 xl:gap-36 p-4">
        ...
        <div className="w-full">
          <div className="flex flex-col items-end w-full">
            <Form
              method="post"
              className="mt-6 p-6 shadow-2xl rounded-lg space-y-4 xl:w-[80%]"
            >
              <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="block w-full h-24 px-5 py-3 mt-2 text-gray-700  bg-white border border-gray-200 rounded-md md:h-56   focus:border-red-500  focus:ring-red-500 focus:outline-none focus:ring focus:ring-opacity-40"
                  placeholder="Message"
                ></textarea>
              </div>
