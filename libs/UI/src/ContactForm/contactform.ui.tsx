...
export function ContactForm({ contactUsData, isSubmitting }: any) {
            ...
            <Form method="post" className="mt-6 p-6 shadow-2xl rounded-lg space-y-4 xl:w-[80%]">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="block w-full h-24 px-5 py-3 mt-2 text-gray-700  bg-white border border-gray-200 rounded-md md:h-56   focus:border-red-500  focus:ring-red-500 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
              </div>
